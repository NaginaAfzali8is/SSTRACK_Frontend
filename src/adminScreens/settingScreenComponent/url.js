...
function UrlTracking(props) {
    ...
    const handleApplySettings = async (employee, check) => {
        ...
        try {
            const res = await axios.patch(`https://sstrackinf.vercel.app/api/v1/owner/settingsE/${employee._id}`, {
                userId: employee._id,
    ...
    async function handleApply(urlTracking) {
        try {
            const res = await axios.patch(`https://sstrackinf.vercel.app/api/v1/superAdmin/settingsE`,
    ...
    async function getData() {
        try {
            const response = await fetch(`https://sstrackinf.vercel.app/api/v1/superAdmin/employees`, { headers })
